...
CREATE TABLE TB_DEVICE(
    ...
    DV_CURRENTQTY NUMBER DEFAULT 0 NOT NULL,
    DV_POWER NUMBER,
    DV_WEIGHT NUMBER,
    DV_LAMP VARCHAR2(9)
);
...
COMMENT ON COLUMN TB_DEVICE.DV_CURRENTQTY IS '현수량';
...
VALUES(SEQ_DVNO.NEXTVAL, 'MovingLight', 'sola spot pro cmy', 'highend', 30, 30, 720, 40, 'LED');
INSERT INTO TB_DEVICE (DV_NO, DV_CATEGORY, DV_NAME, DV_MANUFACTURE, DV_TOTALQTY, DV_CURRENTQTY, DV_POWER, DV_WEIGHT)
VALUES(SEQ_DVNO.NEXTVAL, 'Convention', 'f101', 'adb', 100, 100, 1200, 25.5);
INSERT INTO TB_DEVICE (DV_NO, DV_CATEGORY, DV_NAME, DV_TOTALQTY, DV_CURRENTQTY)
VALUES(SEQ_DVNO.NEXTVAL, 'Line', 'extension 10m', 50, 50);
